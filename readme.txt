# Getting Started with Zeomega Training Angular Project

This repository contains the source code for the Zeomega Training Angular project. This project is designed to demonstrate how to build an online store application using AngularJS.
...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/spruthvika/Zeomega-training-angular.git
...
3. Start the JSON server using the json-server package:
    ...
    npx json-server@0.17.4 products.json -p 3030

4. The JSON server should now be running and serving the mock product data from the products.json file.
